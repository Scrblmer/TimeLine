...
// configuration step. It creates a namespace called `TimeLine`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", TimeLine::cmake::project_name, TimeLine::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", TimeLine::cmake::project_version);
      return EXIT_SUCCESS;
    }
